...
@SpringBootTest
public class AlitababaApplicationTests2 {
    @Autowired
    private UserService userService;
    @Autowired
    private UserController userController;
    @Rule
    public final SputnikWatcher watchman = new SputnikWatcher();
   ...
   /* public void testSelect3() {
    ...
    public void testChain() {
        System.out.println(("----- selectAll method test ------"));
        TraceUtil.traceInvocation(ServiceLocatorLocator.class,false);
