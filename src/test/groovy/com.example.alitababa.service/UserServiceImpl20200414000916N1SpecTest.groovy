...
*/
class UserServiceImpl20200414000916N1SpecTest extends Specification {
    ...
    @BMRules(rules = [
            @BMRule(
                name = "invoke_static:com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest",
                targetClass = "com.example.alitababa.service.ServiceLocatorLocator",
                targetMethod = "compute(int,int)",
                binding = 'mockHandler:com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest$StaticStub98=getMock("com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest")',
                targetLocation = "AT ENTRY",
                helper='com.zte.sputnik.extension.InvokeStaicHelper',
                condition = 'hasMethod("com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest")',
                action = 'return mockHandler.compute($1,$2)'
            ),
            @BMRule(
                name = "invoke_static:com.example.alitababa.service.ServiceLocatorLocator::findServiceLocator()@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest",
                targetClass = "com.example.alitababa.service.ServiceLocatorLocator",
                targetMethod = "findServiceLocator()",
                binding = 'mockHandler:com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest$StaticStub99=getMock("com.example.alitababa.service.ServiceLocatorLocator::findServiceLocator()@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest")',
                targetLocation = "AT ENTRY",
                helper='com.zte.sputnik.extension.InvokeStaicHelper',
                condition = 'hasMethod("com.example.alitababa.service.ServiceLocatorLocator::findServiceLocator()@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest")',
...
def subject = new com.example.alitababa.service.UserServiceImpl()
    ...
    invokeStaticDefs['com.example.alitababa.service.ServiceLocatorLocator::findServiceLocator()@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest']=Mock(StaticStub99){
    ...
    invokeStaticDefs['com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414000916N1SpecTest']=Mock(StaticStub98){
