...
*/
class UserServiceImpl20200414001054N2SpecTest extends Specification {
    ...
    @BMRules(rules = [
            @BMRule(
                name = "invoke_static:com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414001054N2SpecTest",
                targetClass = "com.example.alitababa.service.ServiceLocatorLocator",
                targetMethod = "compute(int,int)",
                binding = 'mockHandler:com.example.alitababa.service.UserServiceImpl20200414001054N2SpecTest$StaticStub253=getMock("com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414001054N2SpecTest")',
                targetLocation = "AT ENTRY",
                helper='com.zte.sputnik.extension.InvokeStaicHelper',
                condition = 'hasMethod("com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414001054N2SpecTest")',
...
def subject = new com.example.alitababa.service.UserServiceImpl()
    ...
    invokeStaticDefs['com.example.alitababa.service.ServiceLocatorLocator::compute(int,int)@com.example.alitababa.service.UserServiceImpl20200414001054N2SpecTest']=Mock(StaticStub253){
